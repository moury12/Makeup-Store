              ...
              children: [
                  ...
                  return SizedBox(
                    ...
                    child: PageView.builder(
                      ...
                      itemCount: ProductDetailsController
                                  .to.product.value.variationType ==
                              'shade'
                          ? ProductDetailsController
                              .to.product.value.productShades!
                              .firstWhere((element) =>
                                  element.shadeId ==
                                  ProductDetailsController
                                      .to.selectedVariation.value)
                              .productShadeImages!
                              .length
                          : ProductDetailsController
                              .to.product.value.productSizes!
                              .firstWhere((element) =>
                                  element.sizeId ==
                                  ProductDetailsController
                                      .to.selectedVariation.value)
                      ...
                      itemBuilder: (context, index) {
                        String data = ProductDetailsController
                                    .to.product.value.variationType ==
                                'shade'
                            ? ProductDetailsController
                                .to.product.value.productShades!
                        ...
                        return GestureDetector(
                          onTap: () {
                            ProductDetailsController
                                .to.selectedImageForPage.value = index;
                            Get.toNamed(
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      // ),
                      RatingWidget(
                          rating: double.tryParse(ProductDetailsController
                                  .to.product.value.reviewsAvgStar!) ??
                              0,
                      ...
                      RichText(
                        ...
                        TextSpan(
                            text:
                                '(${ProductDetailsController.to.product.value.reviewsCount!})',
                        ...
                        RichText(
                            text: TextSpan(
                              ...
                              TextSpan(
                                  ...
                                  style: AppTheme.textStyleBoldBlack20,
                                  children: ProductDetailsController.to
                                              .discountPercent() ==
                                          0
                                      ? []
                                      : [
                                          TextSpan(
                                            text:
                                                '৳${ProductDetailsController.to.getActualPrice()}',
                                            style: const TextStyle(
                                                decoration:
                                          ...
                                          TextSpan(
                                            text:
                                                '(-${ProductDetailsController.to.discountPercent().toStringAsFixed(1)}% Off)',
                                            style: const TextStyle(
                    ...
                    child: Column(
                      ...
                      children: [
                        if (ProductDetailsController
                            ...
                            'shade')
                          Wrap(
                            children: ProductDetailsController
                                .to.product.value.productShades!
                                .firstWhere((element) =>
                                    element.shadeId ==
                                    ProductDetailsController
                            ...
                            children: ProductDetailsController
                                ...
                                .map(
                                  (e) => Padding(
                                    ...
                                    child: Text(
                                      e.productDetails!.offer!.offerTypeId ==
                                              '3'
                                          ? e.productDetails!.offer!.name!
                                          : e.productDetails!.offer!.title1!,
                                      style: const TextStyle(
                                          fontSize: 14,
                                          fontWeight: FontWeight.w600,
                        ...
                        ? [
                            ...
                            SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                scrollDirection: Axis.horizontal,
                                itemBuilder: (context, index) {
                                  final shade = ProductDetailsController
                                      .to.product.value.productShades![index];
                                  return Padding(
                                ...
                                itemCount: ProductDetailsController
                                    .to.product.value.productShades!.length,
                              ),
                            ),
                            Obx(
                              () => RichText(
                            ...
                            Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: ListView.builder(
                                  ...
                                  scrollDirection: Axis.horizontal,
                                  itemCount: ProductDetailsController
                                      .to.product.value.productSizes!.length,
                                  itemBuilder: (context, index) {
                                    final size = ProductDetailsController
                                        .to.product.value.productSizes![index];
                                    return Obx(() {
                                      return GestureDetector(
                                        onTap: () {
                  ...
                  child: Row(
                    children: [
                      ...
                      if (AuthController.to.isLoggedIn.value &&
                          ProductDetailsController
                                  .to.product.value.reviewEligible ==
                              'true')
                        GestureDetector(
                          onTap: () {
                ...
                Obx(
                  () => ProductDetailsController.to.reviewImages.isNotEmpty
                      ? GestureDetector(
                          onTap: () async {
                            ProductDetailsController.to.reviewFilterList
                                .firstWhere((element) =>
                                    element['key'] ==
                                    'with_image')['is_selected'] = true;
                            ProductDetailsController.to.reviewFilterList
                                .refresh();
                            ProductDetailsController.to.update();
                            await ProductDetailsController.to
                                .getAllReviews(addition: {'with_image': '1'});
                          ...
                          child: Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                padding: EdgeInsets.zero,
                                itemBuilder: (context, index) {
                                  final reviewImage = ProductDetailsController
                                      .to.reviewImages[index];
                ...
                ...List.generate(
                  ...
                  (index) => CommentWidget(
                    index: 1,
                    readMore: false,
                    reviews: ProductDetailsController
                        .to.product.value.reviews![index],
                ...
                GestureDetector(
                  onTap: () async {
                    ProductDetailsController.to.reviewFilterList.firstWhere(
                            (element) =>
                                element['key'] == 'with_image')['is_selected'] =
                        false;
          ...
          children: [
            ...
            Obx(() {
              return GestureDetector(
                onTap: () async {
                  if (AuthController.to.isLoggedIn.value) {
                    await UserController.to.addToWish(
                        ProductDetailsController.to.product.value.id!);
                  } else {
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(4)),
                  child: AuthController.to.isLoggedIn.value &&
                          UserController.to.wishList.any((element) =>
                              element.productId ==
                              ProductDetailsController.to.product.value.id)
                      ? Image.asset(
            ...
            Expanded(
              child: Obx(() {
                ...
                return (cartModel == null || cartModel == true)
                    ? CustomButton(
                        label: (ProductDetailsController
                                        .to.product.value.variationType ==
                                    'size'
                                ? ProductDetailsController
                                        .to.product.value.productSizes!
                        ...
                        height: 46,
                        isBorder: false,
                        prefixImage: (ProductDetailsController
                                        .to.product.value.variationType ==
                                    'size'
                                ? ProductDetailsController
                                        .to.product.value.productSizes!
                            ...
                            if (ProductDetailsController
                              ...
                              final data = {
                                ...
                                if (ProductDetailsController
                                        .to.product.value.variationType ==
                                    'size')
                                  "size_id": ProductDetailsController
                                      .to.selectedVariation.value,
                                if (ProductDetailsController
                                        .to.product.value.variationType ==
                                    'shade')
                                  "shade_id": ProductDetailsController
                                      .to.selectedVariation.value,
                              };
                              globalLogger.d(data);
                          ...
                          children: [
                            GestureDetector(
                              ...
                              child: Padding(
                                ...
                                child: Icon(
                                  Icons.remove,
                                  color: int.parse((cartModel as CartModel)
                                              .quantity!) ==
                                          (/*(cartModel as CartModel)?.buyGetInfo != null ? (int.parse((cartModel as CartModel)!.buyGetInfo!.buyQuantity!)) :*/ 1)
  ...
  switch (tabIndex) {
    case 0:
      return Padding(
        padding: const EdgeInsets.symmetric(horizontal: 16.0),
        child: Stack(
          alignment: Get.currentRoute == ProductDescriptionScreen.routeName
              ? Alignment.topLeft
          ...
          children: [
            ...
            Html(
              data: findAndRemove(
                  findAndRemove(
                      ProductDetailsController.to.product.value.description!,
                      'margin',
                      ';'),
                  'line-height',
                  ';'),
            ...
            if (Get.currentRoute != ProductDescriptionScreen.routeName)
              Container(
                ...
                decoration: const BoxDecoration(boxShadow: [
                  BoxShadow(
                      color: Colors.white, blurRadius: 60, spreadRadius: 50)
                ]),
              ),
          ],
        ),
      ...
      return Padding(
        ...
        child: Html(
          data: findAndRemove(
              findAndRemove(
                  ProductDetailsController
                      .to.product.value.ingredientDescription!,
                  'margin',
                  ';'),
              'line-height',
              ';'),
    ...
    case 2:
      return Padding(
        ...
        child: Html(
          data: findAndRemove(
              findAndRemove(ProductDetailsController.to.product.value.howToUse!,
                  'margin', ';'),
              'line-height',
              ';'),
          style: {
    ...
    case 3:
      return Padding(
        ...
        child: Html(
          data: findAndRemove(
              findAndRemove(ProductDetailsController.to.product.value.faq!,
                  'margin', ';'),
              'line-height',
              ';'),
          style: {
