  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
                color: AppColors.kDarkPrimaryColor.withOpacity(.12),
                blurRadius: 12)
          ]),
      child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            ...
                            style: AppTheme.textStyleBoldBlack12.copyWith(
                                fontFamily: 'InriaSans', fontSize: 14),
                            maxLines: 2,
                        ...
                        flatten(product!.variationType == 'shade'
                                ...
                                .where((element) =>
                                    element
                                        .productDetails?.offer?.offerTypeId ==
                                    '3')
                                .isNotEmpty
                            ? Wrap(
                                children: flatten(
                                    ...
                                    .map((e) => Padding(
                                          ...
                                          child: Container(
                                              ...
                                              child: Text(
                                                  e.productDetails?.offer
                                                          ?.name ??
                                                      '-',
                                                  style: AppTheme
                                                      .textStyleBoldWhite10)),
                                        ))
                                    .toList(),
                              )
                    ...
                    onPressed: product?.totalStock != '0'
                        ...
                        : () async {
                            ...
                            Get.to(ProductShadeScreen(
                              isSelectSize: product?.variationType == 'shade'
                                  ? false
                                  : true,
                            ));
                          },
          ...
          onTap: () async {
            if (category.categories != null) {
              HomeApiController.to.categoryList
                  .firstWhere(
                      (element) => element.id == category.categories!.id!)
                  .isChecked = true;
      ...
      children: [
        Positioned(
          ...
          child: CustomNetworkImage(
              networkImagePath: model.banner ?? '',
              height: 220,
              width: double.infinity,
              borderRadius: 0,
              fit: BoxFit.fill,
              errorImagePath: AssetsConstant.bottomGrettings),
        ),
        SizedBox(
          width: double.infinity,
          height: 220,
