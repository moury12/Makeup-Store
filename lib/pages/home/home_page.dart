    ...
    switch (model.id!) {
      case '1':
        return model.sectionData!.isNotEmpty
            ? SizedBox(
                ...
                child: Obx(
                  () {
                    HomeController.to.startBannerAutoScroll(model.sectionData!
                        .map((e) => e.offers!.bannerMobile!)
                        .toList());
      ...
      case 'cat':
        return Center(
          child: Padding(
            ...
            child: Obx(() {
              final catList = HomeApiController.to.categoryList
                  .where((p0) => p0.showOnHeader == '1')
                  .toList()
                ..sort((a, b) => a.position!.compareTo(b.position!));
              globalLogger.d(catList.map((e) => e.name).toList(), 'cattttt');
              return Wrap(
                children: catList
                        .map((cat) => GestureDetector(
                            onTap: () async {
                              ...
                              HomeApiController.to.categoryList
                                  .firstWhere((element) => element.id == cat.id)
                                  .isChecked = true;
      ...
      case '4':
        return model.sectionData!.isNotEmpty
            ? Column(
                ...
                children: [
                  TitleTextWidget(
                      tileText: model.mobileTitle ?? 'Deals You Cannot Miss'),
                  GridView.builder(
      ...
      case '3':
        return model.sectionData!.isNotEmpty
            ? Column(
                ...
                children: [
                  TitleTextWidget(
                      tileText: model.mobileTitle ?? 'Top Brands & Offers'),
                  ...List.generate(
                    model.sectionData!.length,
                    (index) => GestureDetector(
                      onTap: () async {
                        await HomeApiController.to.offerDetailsCall(
                            model.sectionData![index].offerId!);
                        Get.toNamed(OfferDetailsScreen.routeName);
                      },
      ...
      case '6':
        return model.productList!.isNotEmpty
            ? BestSellerListViewBuilder(model: model)
            : const SizedBox.shrink();
      case '16':
        return model.productList!.isNotEmpty
            ? Column(
      ...
      case '10':
        return model.sectionData!.isNotEmpty
            ? Column(
                ...
                children: [
                  TitleTextWidget(
                      tileText: model.mobileTitle ?? 'Clearance Sale'),
                  GestureDetector(
                    onTap: () async {
                      await HomeApiController.to
                          .offerDetailsCall(model.sectionData!.first.offerId!);
                      Get.toNamed(OfferDetailsScreen.routeName);
                    },
                    child: Container(
                      margin: const EdgeInsets.symmetric(
      ...
      case '12':
        return model.sectionData!.isNotEmpty
            ? Column(
                ...
                children: [
                  TitleTextWidget(
                      tileText: model.mobileTitle ?? 'Segments You Can’t Miss'),
      ...
      case '14':
        return model.sectionData!.isNotEmpty
            ? Column(
                ...
                children: [
                  TitleTextWidget(
                      tileText: model.mobileTitle ?? 'Shop By Concern'),
                  SegmentGridWidget(
                    model: model,
      ...
      case '11':
        return model.sectionData!.isNotEmpty
            ? Column(
                ...
                children: [
                  TitleTextWidget(
                      tileText: model.mobileTitle ?? 'Perfecto Tips & Tricks'),
                  GridView.builder(
                    padding: const EdgeInsets.symmetric(horizontal: 16),
                    shrinkWrap: true,
                    primary: false,
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                color: AppColors.kPrimaryColor,
                                width:
                                    2.5), /* image: const DecorationImage(image: AssetImage(AssetsConstant.slider1), fit: BoxFit.fill)*/
                          ),
                          child: Stack(
                            children: [
                              CustomNetworkImage(
                              ...
                              Align(
                                alignment: Alignment.center,
                                child: Image.asset(AssetsConstant.playButton,
                                    height: 22, width: 22),
                              ),
                            ],
                          ),
        ...
        Expanded(
          child: Obx(() {
            return RefreshIndicator(
              ...
              child: HomeController.to.homeLoadingStatus.value ==
          ...
          //                               videoList: const ['https://www.youtube.com/watch?v=gJLVTKhTnog'],
          //                               width: Get.width * .8,
          //                             ),
          //                           ),
          //                         ),
