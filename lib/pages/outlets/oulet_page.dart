                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Obx(() {
                        final outletList = (OfferController.to.outletController.value.text.isEmpty ? HomeApiController.to.outletList : HomeApiController.to.outletList.where((element) => element.name!.toLowerCase().contains(OfferController.to.outletController.value.text.toLowerCase())).toList());
