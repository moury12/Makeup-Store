            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  if (HomeApiController.to.offerDetails.value.data == null || (HomeApiController.to.offerDetails.value.data != null && HomeApiController.to.offerDetails.value.data!.isEmpty && HomeApiController.to.offerDetails.value.offerTypeId != '2'))
                    const SizedBox(
                      height: 200,
                      child: Center(
